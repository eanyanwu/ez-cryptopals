...
mod unit_tests {
    ...
    fn test_base64_to_bytes() {
        assert_eq!(vec![b'M', b'a', b'n'], radix::base64_to_bytes("TWFu"));
        assert_eq!(vec![b'M', b'a'], radix::base64_to_bytes("TWE="));
        assert_eq!(vec![b'M'], radix::base64_to_bytes("TQ=="));
    }
    ...
    fn test_base64_to_sextet() {
        assert_eq!(0, radix::base64_to_sextet(&b'A'));
        assert_eq!(25, radix::base64_to_sextet(&b'Z'));

        assert_eq!(26, radix::base64_to_sextet(&b'a'));
        assert_eq!(51, radix::base64_to_sextet(&b'z'));

        assert_eq!(52, radix::base64_to_sextet(&b'0'));
        assert_eq!(61, radix::base64_to_sextet(&b'9'));

        assert_eq!(62, radix::base64_to_sextet(&b'+'));
        assert_eq!(63, radix::base64_to_sextet(&b'/'));
    }
}