...
pub mod test {
    ...
    pub fn convert_hex_to_base64() {
        ...
        let bytes = challenge01::ascii_hex_to_bytes(hex_input);
        let actual_base64_output = challenge01::bytes_to_ascii_base64(&bytes);
    ...
    fn test_ascii_hex_to_bytes()
    {
        ...
        assert_eq!(vec![0x01, 0x23], challenge01::ascii_hex_to_bytes("123"));
    }
    ...
    fn test_byte_to_ascii_base64() {
        ...
        assert_eq!(b'a', challenge01::byte_to_ascii_base64(&26));
        assert_eq!(b'z', challenge01::byte_to_ascii_base64(&51));

        assert_eq!(b'0', challenge01::byte_to_ascii_base64(&52));
        assert_eq!(b'9', challenge01::byte_to_ascii_base64(&61));

        assert_eq!(b'+', challenge01::byte_to_ascii_base64(&62));
        assert_eq!(b'/', challenge01::byte_to_ascii_base64(&63));
    }
    ...
    fn test_bytes_to_ascii_base64() {
        ...
        assert_eq!(String::from("TWE="), challenge01::bytes_to_ascii_base64(&[b'M', b'a']));
        assert_eq!(String::from("TQ=="), challenge01::bytes_to_ascii_base64(&[b'M']));
    }
}